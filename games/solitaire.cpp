...
void Solitaire::DrawGame(const MainData& dat)
{
    ...
    {
        glColor3ub(255, 0, 0);
        glRasterPos2d(700 - 100, 75 + 75 + 5);
        YsGlDrawFontBitmap20x28("Select");
        glRasterPos2d(700 - 100, 100 + 75 + 5);
        YsGlDrawFontBitmap20x28("Source");
    }
    else
    {
        glColor3ub(255, 0, 0);
        glRasterPos2d(700 - 100, 75 + 75 + 5);
        YsGlDrawFontBitmap20x28("Select");
        glRasterPos2d(650 - 150, 100 + 75 + 5);
        YsGlDrawFontBitmap20x28("Destination");
    }
...
int Solitaire::PlaySolitaire(const MainData& dat)
{
    ...
    while (CheckWin() == false)
    {
        ...
        if (FSMOUSEEVENT_LBUTTONDOWN == evt)
        {
            ...
            if (mx > st.locx + 65 && mx < st.locx + 10 + 65 && my > st.locy - 10 + 20 && my < st.locy + 20)
            {
                turn = 0;
                if (st.cards.size() != 0)
                {
            ...
            {
                if (mx > dis.locx + 65 && mx < dis.locx + 10 + 65 && my > dis.locy - 10 + 20 && my < dis.locy + 20)
                {
                ...
                else if (mx > s1.locx + 65 && mx < s1.locx + 10 + 65 && my > s1.locy - 10 + 20 && my < s1.locy + 20)
                {
                ...
                else if (mx > s2.locx + 65 && mx < s2.locx + 10 + 65 && my > s2.locy - 10 + 20 && my < s2.locy + 20)
                {
                ...
                else if (mx > s3.locx + 65 && mx < s3.locx + 10 + 65 && my > s3.locy - 10 + 20 && my < s3.locy + 20)
                {
                ...
                else if (mx > s4.locx + 65 && mx < s4.locx + 10 + 65 && my > s4.locy - 10 + 20 && my < s4.locy + 20)
                {
                ...
                else if (mx > t1u.locx + 65 && mx < t1u.locx + 10 + 65)
                {
                    if (my > t1u.locy - 10 + 20 && my < t1u.locy + 20 * (t1u.cards.size() - 1) + 20)
                    {
                        ...
                        tempNumCards = t1u.cards.size() - (my - t1u.locy + 10 - 20) / 20;
                        turn = 1;
                    }
                }
                else if (mx > t2u.locx + 65 && mx < t2u.locx + 10 + 65)
                {
                    if (my > t2u.locy - 10 + 20 && my < t2u.locy + 20 * (t2u.cards.size() - 1) + 20)
                    {
                        ...
                        tempNumCards = t2u.cards.size() - (my - t2u.locy + 10 - 20) / 20;
                        turn = 1;
                    }
                }
                else if (mx > t3u.locx + 65 && mx < t3u.locx + 10 + 65)
                {
                    if (my > t3u.locy - 10 + 20 && my < t3u.locy + 20 * (t3u.cards.size() - 1) + 20)
                    {
                        ...
                        tempNumCards = t3u.cards.size() - (my - t3u.locy + 10 - 20) / 20;
                        turn = 1;
                    }
                }
                else if (mx > t4u.locx + 65 && mx < t4u.locx + 10 + 65)
                {
                    if (my > t4u.locy - 10 + 20 && my < t4u.locy + 20 * (t4u.cards.size() - 1) + 20)
                    {
                        ...
                        tempNumCards = t4u.cards.size() - (my - t4u.locy + 10 - 20) / 20;
                        turn = 1;
                    }
                }
                else if (mx > t5u.locx + 65 && mx < t5u.locx + 10 + 65)
                {
                    if (my > t5u.locy - 10 + 20 && my < t5u.locy + 20 * (t5u.cards.size() - 1) + 20)
                    {
                        ...
                        tempNumCards = t5u.cards.size() - (my - t5u.locy + 10 - 20) / 20;
                        turn = 1;
                    }
                }
                else if (mx > t6u.locx + 65 && mx < t6u.locx + 10 + 65)
                {
                    if (my > t6u.locy - 10 + 20 && my < t6u.locy + 20 * (t6u.cards.size() - 1) + 20)
                    {
                        ...
                        tempNumCards = t6u.cards.size() - (my - t6u.locy + 10 - 20) / 20;
                        turn = 1;
                    }
                }
                else if (mx > t7u.locx + 65 && mx < t7u.locx + 10 + 65)
                {
                    if (my > t7u.locy - 10 + 20 && my < t7u.locy + 20 * (t7u.cards.size() - 1) + 20)
                    {
                        ...
                        tempNumCards = t7u.cards.size() - (my - t7u.locy + 10 - 20) / 20;
                        turn = 1;
                    }
                }
            }
            ...
            {
                if (mx > s1.locx + 65 && mx < s1.locx + 10 + 65 && my > s1.locy - 10 + 20 && my < s1.locy + 20)
                {
        ...
        DrawRect(s1.locx + 5 + 65, s1.locy - 5 + 20, 10, 10);
        DrawRect(s2.locx + 5 + 65, s2.locy - 5 + 20, 10, 10);
        DrawRect(s3.locx + 5 + 65, s3.locy - 5 + 20, 10, 10);
        DrawRect(s4.locx + 5 + 65, s4.locy - 5 + 20, 10, 10);
        DrawRect(dis.locx + 5 + 65, dis.locy - 5 + 20, 10, 10);
        DrawRect(st.locx + 5 + 65, st.locy - 5 + 20, 10, 10);
        for (int rectNum = 0; rectNum < t1u.cards.size(); rectNum++)
        {
            DrawRect(t1u.locx + 5 + 65, t1u.locy - 5 + 20 * rectNum + 20, 10, 10);
        }
        for (int rectNum = 0; rectNum < t2u.cards.size(); rectNum++)
        {
            DrawRect(t2u.locx + 5 + 65, t2u.locy - 5 + 20 * rectNum + 20, 10, 10);
        }
        for (int rectNum = 0; rectNum < t3u.cards.size(); rectNum++)
        {
            DrawRect(t3u.locx + 5 + 65, t3u.locy - 5 + 20 * rectNum + 20, 10, 10);
        }
        for (int rectNum = 0; rectNum < t4u.cards.size(); rectNum++)
        {
            DrawRect(t4u.locx + 5 + 65, t4u.locy - 5 + 20 * rectNum + 20, 10, 10);
        }
        for (int rectNum = 0; rectNum < t5u.cards.size(); rectNum++)
        {
            DrawRect(t5u.locx + 5 + 65, t5u.locy - 5 + 20 * rectNum + 20, 10, 10);
        }
        for (int rectNum = 0; rectNum < t6u.cards.size(); rectNum++)
        {
            DrawRect(t6u.locx + 5 + 65, t6u.locy - 5 + 20 * rectNum + 20, 10, 10);
        }
        for (int rectNum = 0; rectNum < t7u.cards.size(); rectNum++)
        {
            DrawRect(t7u.locx + 5 + 65, t7u.locy - 5 + 20 * rectNum + 20, 10, 10);
        }

        if (t1u.cards.size() == 0)
        {
            DrawRect(t1u.locx + 5 + 65, t1u.locy - 5 + 20, 10, 10);
        }

        if (t2u.cards.size() == 0 && t2d.cards.size() == 0)
        {
            DrawRect(t2d.locx + 5 + 65, t2d.locy - 5 + 20, 10, 10);
        }

        if (t3u.cards.size() == 0 && t3d.cards.size() == 0)
        {
            DrawRect(t3d.locx + 5 + 65, t3d.locy - 5 + 20, 10, 10);
        }

        if (t4u.cards.size() == 0 && t4d.cards.size() == 0)
        {
            DrawRect(t4d.locx + 5 + 65, t4d.locy - 5 + 20, 10, 10);
        }

        if (t5u.cards.size() == 0 && t5d.cards.size() == 0)
        {
            DrawRect(t5d.locx + 5 + 65, t5d.locy - 5 + 20, 10, 10);
        }

        if (t6u.cards.size() == 0 && t6d.cards.size() == 0)
        {
            DrawRect(t6d.locx + 5 + 65, t6d.locy - 5 + 20, 10, 10);
        }

        if (t7u.cards.size() == 0 && t7d.cards.size() == 0)
        {
            DrawRect(t7d.locx + 5 + 65, t7d.locy - 5 + 20, 10, 10);
        }
        FsSwapBuffers();
        FsSleep(100);
    }
